/*
 * ============================================================================
 * DUAL-CORE RIGHT HAND WIFI STREAMER WITH SPI POLLING
 * Core 0: Dedicated sensor polling (BNO085 + Flex + FSR)
 * Core 1: WiFi + UDP streaming
 * Streams raw IMU + Flex + FSR data at 200Hz via UDP with 2-3ms latency
 * ============================================================================
 */
...
void setup() {
  ...
  Serial.println("🚀 DUAL-CORE RIGHT HAND WIFI SPI STREAMER");
...
void streamData() {
  ...
  // No need to read sensors here - Core 0 handles it!
